...
This is a NodeJS API that supports username and password authentication with JWTs, modified for an JWT workshop, originally created by Martin Gontovnikas
